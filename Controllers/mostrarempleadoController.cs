...
{
    public class mostrarempleadoController : ApiController
    {
        [HttpGet]
        public List<String> IdResultado()
        {
            string sql = "SELECT idempleados,nombre, transporte,telefono FROM empleados";
            ...
            try
            {
                ...
                mostrarempleados resultado = new mostrarempleados();
                while (cursor.Read())
                {
